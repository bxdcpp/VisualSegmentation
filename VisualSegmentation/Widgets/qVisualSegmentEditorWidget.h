...
#ifndef __qVisualSegmentEditorWidget_h
#define __qVisualSegmentEditorWidget_h
...
///
class Q_SLICER_MODULE_VISUALSEGMENTATION_WIDGETS_EXPORT qVisualSegmentEditorWidget : public qMRMLWidget
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  /// Constructor
  explicit qVisualSegmentEditorWidget(QWidget* parent = nullptr);
  /// Destructor
  ~qVisualSegmentEditorWidget() override;
...
protected:
  QScopedPointer<qVisualSegmentEditorWidgetPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qVisualSegmentEditorWidget);
  Q_DISABLE_COPY(qVisualSegmentEditorWidget);
};

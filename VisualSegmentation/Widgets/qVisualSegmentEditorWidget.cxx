...
public:
  ...
  QPointer<qVisualSegmentEditorWidget> EditorWidget;
...
//-----------------------------------------------------------------------------
// qVisualSegmentEditorWidgetPrivate methods

//-----------------------------------------------------------------------------
class qVisualSegmentEditorWidgetPrivate: public Ui_qVisualSegmentEditorWidget
{
...
public:
  qVisualSegmentEditorWidgetPrivate(qVisualSegmentEditorWidget& object);
...
//-----------------------------------------------------------------------------
qVisualSegmentEditorWidgetPrivate::qVisualSegmentEditorWidgetPrivate(qVisualSegmentEditorWidget& object)
  : q_ptr(&object)
  , Locked(false)
...
//-----------------------------------------------------------------------------
qVisualSegmentEditorWidgetPrivate::~qVisualSegmentEditorWidgetPrivate()
{
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidgetPrivate::init()
{
  Q_Q(qVisualSegmentEditorWidget);
  this->setupUi(q);
...
//-----------------------------------------------------------------------------
QToolButton* qVisualSegmentEditorWidgetPrivate::toolButton(qSlicerSegmentEditorAbstractEffect* effect)
{
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidgetPrivate::notifyEffectsOfReferenceGeometryChange(const std::string& geometry)
{
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidgetPrivate::notifyEffectsOfMasterVolumeNodeChange()
{
  foreach(qSlicerSegmentEditorAbstractEffect* effect, this->RegisteredEffects)
    {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidgetPrivate::notifyEffectsOfLayoutChange()
{
  foreach(qSlicerSegmentEditorAbstractEffect* effect, this->RegisteredEffects)
    {
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::resetModifierLabelmapToDefault()
{
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::updateSelectedSegmentLabelmap()
{
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::updateAlignedMasterVolume()
{
  if (!this->ParameterSetNode)
    {
    qCritical() << Q_FUNC_INFO << ": Invalid segment editor parameter set node";
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::updateMaskLabelmap()
{
  if (!this->ParameterSetNode)
    {
    qCritical() << Q_FUNC_INFO << ": Invalid segment editor parameter set node";
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::updateReferenceGeometryImage()
{
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidgetPrivate::selectFirstSegment()
{
  if (!this->ParameterSetNode)
    {
    qCritical() << Q_FUNC_INFO << ": Invalid segment editor parameter set node";
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidgetPrivate::setEffectCursor(qSlicerSegmentEditorAbstractEffect* effect)
{
...
//-----------------------------------------------------------------------------
std::string qVisualSegmentEditorWidgetPrivate::getReferenceImageGeometryFromSegmentation(vtkSegmentation* segmentation)
{
  if (!segmentation)
    {
    return "";
...
//-----------------------------------------------------------------------------
std::string qVisualSegmentEditorWidgetPrivate::referenceImageGeometry()
{
  if (!this->ParameterSetNode)
    {
    qCritical() << Q_FUNC_INFO << ": Invalid segment editor parameter set node";
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::segmentationDisplayableInView(vtkMRMLAbstractViewNode* viewNode)
{
  if (!viewNode)
    {
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::segmentationIJKToRAS(vtkMatrix4x4* ijkToRas)
{
  if (!this->ParameterSetNode)
    {
    return false;
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidgetPrivate::setSurfaceSmoothingFactor(double smoothingFactor)
{
  if (!this->ParameterSetNode)
    {
    return false;
...
//-----------------------------------------------------------------------------
qVisualSegmentEditorWidget::qVisualSegmentEditorWidget(QWidget* _parent)
  : qMRMLWidget(_parent)
...
//-----------------------------------------------------------------------------
qVisualSegmentEditorWidget::~qVisualSegmentEditorWidget()
= default;

//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateEffectList()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateWidgetFromMRML()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateMaskingSection()
{
  Q_D(qVisualSegmentEditorWidget);
  if (!this->mrmlScene() || this->mrmlScene()->IsClosing())
    {
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::setMasterRepresentationToBinaryLabelmap()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateWidgetFromSegmentationNode()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateWidgetFromMasterVolumeNode()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onMasterVolumeImageDataModified()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
qSlicerSegmentEditorAbstractEffect* qVisualSegmentEditorWidget::activeEffect()const
{
  Q_D(const qVisualSegmentEditorWidget);

  return d->ActiveEffect;
}

//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setActiveEffect(qSlicerSegmentEditorAbstractEffect* effect)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateEffectsSectionFromMRML()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setMRMLScene(vtkMRMLScene* newScene)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onMRMLSceneEndCloseEvent()
{
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onInteractionNodeModified()
{
  Q_D(const qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
vtkMRMLSegmentEditorNode* qVisualSegmentEditorWidget::mrmlSegmentEditorNode()const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setMRMLSegmentEditorNode(vtkMRMLSegmentEditorNode* newSegmentEditorNode)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
vtkMRMLInteractionNode* qVisualSegmentEditorWidget::interactionNode()const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setInteractionNode(vtkMRMLInteractionNode* interactionNode)
{
  Q_D(qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::initializeParameterSetNode()
{
  Q_D(qVisualSegmentEditorWidget);
  if (!d->ParameterSetNode)
    {
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setSegmentationNode(vtkMRMLNode* node)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
vtkMRMLNode* qVisualSegmentEditorWidget::segmentationNode()const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setSegmentationNodeID(const QString& nodeID)
{
  Q_D(qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
QString qVisualSegmentEditorWidget::segmentationNodeID()const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
QString qVisualSegmentEditorWidget::currentSegmentID()const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setMasterVolumeNode(vtkMRMLNode* node)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
vtkMRMLNode* qVisualSegmentEditorWidget::masterVolumeNode()const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setMasterVolumeNodeID(const QString& nodeID)
{
  Q_D(qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
QString qVisualSegmentEditorWidget::masterVolumeNodeID()const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSegmentationNodeChanged(vtkMRMLNode* node)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSegmentSelectionChanged(const QItemSelection &selected, const QItemSelection &deselected)
{
  Q_UNUSED(selected);
  Q_UNUSED(deselected);
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setCurrentSegmentID(const QString segmentID)
{
  Q_D(qVisualSegmentEditorWidget);
  if (d->ParameterSetNode)
    {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onMasterVolumeNodeChanged(vtkMRMLNode* node)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onEffectButtonClicked(QAbstractButton* button)
{
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onAddSegment()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onRemoveSegment()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
qSlicerAbstractModuleWidget* qVisualSegmentEditorWidget::switchToSegmentationsModule()
{
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSwitchToSegmentations()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onCreateSurfaceToggled(bool on)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSegmentAddedRemoved()
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::showMasterVolumeInSliceViewers(bool forceShowInBackground /*=false*/, bool fitSlice /*=false*/)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onLayoutChanged(int layoutIndex)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
qSlicerSegmentEditorAbstractEffect* qVisualSegmentEditorWidget::effectByName(QString name)
{
  Q_D(qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
QStringList qVisualSegmentEditorWidget::effectNameOrder() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setEffectNameOrder(const QStringList& effectNames)
{
  Q_D(qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::unorderedEffectsVisible() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setUnorderedEffectsVisible(bool visible)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
QStringList qVisualSegmentEditorWidget::availableEffectNames()
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
int qVisualSegmentEditorWidget::effectCount()
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
qSlicerSegmentEditorAbstractEffect* qVisualSegmentEditorWidget::effectByIndex(int index)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setupViewObservations()
{
  Q_D(qVisualSegmentEditorWidget);
  ...
  foreach (QString sliceViewName, layoutManager->sliceViewNames())
    ...
    interactionCallbackCommand->SetCallback( qVisualSegmentEditorWidget::processEvents );
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::removeViewObservations()
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setActiveEffectByName(QString effectName)
{
  qSlicerSegmentEditorAbstractEffect* effect = this->effectByName(effectName);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::saveStateForUndo()
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateVolume(void* volumeToUpdate, bool& success)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::processEvents(vtkObject* caller,
                                        unsigned long eid,
                                        void* clientData,
                                        void* vtkNotUsed(callData))
{
  ...
  qVisualSegmentEditorWidget* self = callbackCommand->EditorWidget.data();
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onMasterVolumeIntensityMaskChecked(bool checked)
{
  Q_D(qVisualSegmentEditorWidget);
  if (!d->ParameterSetNode)
    {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onMasterVolumeIntensityMaskRangeChanged(double min, double max)
{
  Q_D(qVisualSegmentEditorWidget);
  if (!d->ParameterSetNode)
    {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onMaskModeChanged(int index)
{
  Q_D(qVisualSegmentEditorWidget);
  if (!d->ParameterSetNode)
    {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onOverwriteModeChanged(int index)
{
  Q_D(qVisualSegmentEditorWidget);
  if (!d->ParameterSetNode)
    {
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::segmentationNodeSelectorVisible() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setSegmentationNodeSelectorVisible(bool visible)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::masterVolumeNodeSelectorVisible() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setMasterVolumeNodeSelectorVisible(bool visible)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::switchToSegmentationsButtonVisible() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setSwitchToSegmentationsButtonVisible(bool visible)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::undoEnabled() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setUndoEnabled(bool enabled)
{
  Q_D(qVisualSegmentEditorWidget);
  if (enabled)
    {
...
//-----------------------------------------------------------------------------
int qVisualSegmentEditorWidget::maximumNumberOfUndoStates() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setMaximumNumberOfUndoStates(int maxNumberOfStates)
{
  Q_D(qVisualSegmentEditorWidget);
...
//------------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::readOnly() const
{
  Q_D(const qVisualSegmentEditorWidget);
  return d->Locked;
}
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setReadOnly(bool aReadOnly)
{
  Q_D(qVisualSegmentEditorWidget);
  d->Locked = aReadOnly;
  if (aReadOnly)
...
//------------------------------------------------------------------------------
void qVisualSegmentEditorWidget::toggleMasterVolumeIntensityMaskEnabled()
{
  Q_D(qVisualSegmentEditorWidget);
  if (!d->ParameterSetNode)
  {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::undo()
{
  Q_D(qVisualSegmentEditorWidget);
  if (d->SegmentationNode == nullptr)
    {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::redo()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSegmentationHistoryChanged()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::installKeyboardShortcuts(QWidget* parent /*=nullptr*/)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::uninstallKeyboardShortcuts()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSelectEffectShortcut()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSelectSegmentShortcut()
{
  QShortcut* shortcut = qobject_cast<QShortcut*>(sender());
  if (shortcut == nullptr)
    {
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::hideLabelLayer()
{
  Q_D(qVisualSegmentEditorWidget);
  qSlicerLayoutManager* layoutManager = qSlicerApplication::application()->layoutManager();
  if (!layoutManager)
...
//---------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::turnOffLightboxes()
{
  Q_D(qVisualSegmentEditorWidget);
  qSlicerLayoutManager* layoutManager = qSlicerApplication::application()->layoutManager();
  if (!layoutManager)
...
//---------------------------------------------------------------------------
Qt::ToolButtonStyle qVisualSegmentEditorWidget::effectButtonStyle() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setEffectButtonStyle(Qt::ToolButtonStyle toolButtonStyle)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::segmentationNodeSelectorAddAttribute(const QString& nodeType,
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::segmentationNodeSelectorRemoveAttribute(const QString& nodeType,
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::masterVolumeNodeSelectorAddAttribute(const QString& nodeType,
  const QString& attributeName, const QVariant& attributeValue/*=QVariant()*/)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::masterVolumeNodeSelectorRemoveAttribute(const QString& nodeType,
  const QString& attributeName)
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::anchorClicked(const QUrl &url)
{
  if (url.path().isEmpty())
    {
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateEffectLayouts()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onEnableSurfaceSmoothingToggled(bool smoothingEnabled)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSurfaceSmoothingFactorChanged(double newSmoothingFactor)
{
  Q_D(qVisualSegmentEditorWidget);
  // Get segmentation node
  vtkMRMLSegmentationNode* segmentationNode = nullptr;
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onImportExportActionClicked()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onExportToFilesActionClicked()
{
  Q_D(qVisualSegmentEditorWidget);
...
//-----------------------------------------------------------------------------
void qVisualSegmentEditorWidget::onSegmentationDisplayModified()
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
bool qVisualSegmentEditorWidget::autoShowMasterVolumeNode() const
{
  Q_D(const qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::setAutoShowMasterVolumeNode(bool autoShow)
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::updateSliceRotateWarningButtonVisibility()
{
  Q_D(qVisualSegmentEditorWidget);
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::rotateSliceViewsToSegmentation()
{
  Q_D(qVisualSegmentEditorWidget);
    vtkNew<vtkMatrix4x4> segmentationIJKToRAS;
  if (!d->segmentationIJKToRAS(segmentationIJKToRAS.GetPointer()))
...
//---------------------------------------------------------------------------
void qVisualSegmentEditorWidget::showSegmentationGeometryDialog()
{
  Q_D(qVisualSegmentEditorWidget);
